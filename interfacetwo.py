...
def _build_monitor_ui(container):
    ...
    consumo_breakdown_canvas = tk.Canvas(consumo_graph_frame, bg=UI_THEME["bg"], height=74, highlightthickness=0, bd=0)
    consumo_breakdown_canvas.pack(fill=tk.X, padx=0, pady=(0, theme_space("space_1", 4)))
