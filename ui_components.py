...
class AppMetricCard(tk.Frame):
    def __init__(self, parent, title: str, value: str = "0", tone: str = "info", icon: str = "●"):
        ...
        self.bottom_curve = tk.Canvas(self.body, height=14, bg=UI_THEME.get("surface", "#151A22"), highlightthickness=0, bd=0)
    ...
    def _draw_bottom_curve(self, _event=None):
        try:
            w = max(4, int(self.bottom_curve.winfo_width()))
            h = max(4, int(self.bottom_curve.winfo_height()))
